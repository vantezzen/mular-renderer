describe('Layers', function () {
  ...
  describe('BaseAudio', function () {
    ...
    function TestAudio (options) {
      vd.layer.BaseAudio.call(this, options)
    }
    TestAudio.prototype = Object.create(vd.layer.BaseAudio.prototype)
    TestAudio.prototype.attach = function (target) {
      vd.layer.BaseAudio.prototype.attach.call(this, target)
    ...
    it('should call `attach` when an effect is added', function () {
      const effect = new vd.effect.Audio()
      spyOn(effect, 'attach')
      layer.effects.push(effect)
      expect(effect.attach).toHaveBeenCalled()
    })
